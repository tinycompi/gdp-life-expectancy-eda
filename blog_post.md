...
To answer our core question, we plot GDP against Life Expectancy on a facet grid of scatter plots. Because the GDP disparities between nations are so vast, I applied a logarithmic transformation (`np.log10`) to the GDP data. 
